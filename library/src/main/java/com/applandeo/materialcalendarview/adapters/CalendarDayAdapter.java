...
class CalendarDayAdapter extends ArrayAdapter<Date> {
    ...
    public View getView(int position, View view, @NonNull ViewGroup parent) {
        ...
        TextView dayReserve = (TextView) view.findViewById(R.id.dayLabel_sub);
        ...
        if (dayIcon != null) {
            loadIcon(dayIcon, dayReserve, day);
        }
    ...
    private void loadIcon(ImageView dayIcon, TextView tvReserve, Calendar day) {
